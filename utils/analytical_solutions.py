...
def sample():
    ...
    subdomains1 = sample_annulus_points(408, 1, 2)
    subdomains2 = sample_annulus_points(692, 2, 3)
    subdomains3 = sample_annulus_points(964, 3, 4)
    ...
    # 保存为单个npy文件
    np.save('sampling_points.npy', sampling_data)
...
# 保存为npy文件
np.save('analytical_solutions.npy', analytical_data)
